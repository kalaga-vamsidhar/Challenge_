...
async function getProfileInformation(profileIdentifier) {
  const response = await fetch("https://www.linkedin.com/flagship-web/rsc-action/actions/component?componentId=com.linkedin.sdui.generated.profile.dsl.impl.profileCardsExperienceOnly&sduiid=com.linkedin.sdui.generated.profile.dsl.impl.profileCardsExperienceOnly&parentSpanId=viLoTBWx5ac%3D", {
  "headers": {
    "accept": "*/*",
